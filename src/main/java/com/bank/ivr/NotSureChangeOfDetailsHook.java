...
public class NotSureChangeOfDetailsHook extends BaseHook {
	@Override
    ...
    protected void initializeIntent() {
        ...
        intent.setIntentName("not_sure_change_of_details");
        ...
        intent.setIntentAlias("not_sure_change_of_details");
